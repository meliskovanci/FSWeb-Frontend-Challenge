...
export default function PersonalComponent() {
    ...
    return (
        ...
        <section className="w-11/12 h-1/5 ml-16 flex flex-row">
            <div className="">
                ...
                <div id={mode} className="flex ml-16 text-5xl not-italic font-semibold w-4/5 h-1/5 mt-5 dark:text-[#AEBCCF]">
                ...
                <div id={mode} className="flex justify-center  w-96 h-20  ml-16 ">
                    
                    <a href="#hire-me" className="flex justify-center p-3  w-48 h-14 text-lg font-medium text-[#FFFFFF] bg-[#3730A3] border-2 rounded-md dark:bg-[#E1E1FF] dark:text-[#000000]" >{language === "türkçe" ? headerDataTr.infoButtonHireMe : headerData.infoButtonHireMe}</a>
                    {/* <Link id={mode} className="flex justify-center p-3 ml-16 w-48 h-14 text-[#FFFFFF] bg-[#3730A3] border-2 rounded-md dark:bg-[#E1E1FF] dark:text-[#000000]" to="/hire-me">{language === "türkçe" ? headerDataTr.infoButtonHireMe : headerData.infoButtonHireMe}</Link> */}
            ...
            <div className="w-1/5 h-1/5 mt-8 mr-16">
                    ...
                    <img src={profileAboutMe.mainImg} alt="resim" className="absolute rounded-3xl shadow-lg " />
